...
INSERT INTO `conjunctions` (`id`, `conjunction`) VALUES
(0, 'LONELY AND COLD'),
(3, 'BOW AND ARROW'),
(4, 'RED AND BLUE'),
(5, 'DOGS AND CATS'),
...
(56, 'SAFE AND SOUND'),
(71, 'ELEPHANTS AND LIONS'),
(72, 'ANTS OR SPIDERS'),
(73, 'READ OR LISTEN'),
(74, 'INDIVIDUAL OR GROUP'),
(75, 'OPPOSITE OR ALIKE'),
(76, 'TEARS AND SWEAT'),
(77, 'HOLIDAY AND CHEER'),
(78, 'HARMONY OR CHAOS'),
(80, 'NORTH OR SOUTH'),
(81, 'EAST OR WEST'),
(82, 'WINTER OR SUMMER'),
...
(501, 'metallic', 'something with a metal appearance'),
(502, 'elk', 'a large deer-like animal'),
(503, 'rabbit', 'a small mammal with two large teeth and ears'),
(504, 'railroad', 'a road for trains'),
(505, 'young', 'the opposite of old'),
(506, 'cape', 'a large free cloth worn'),
(507, 'heir', 'someone who will recieve something when another dies'),
(508, 'rope', 'thick intertwined string'),
(509, 'illness', 'something that causes a person to be unwell'),
(510, 'song', 'music with words'),
(511, 'UNIQUE', 'An adjective for something unusual'),
...
(999, 'TOP', 'the opposite of bottom'),
(9991, 'TOOTH', 'something used for chewing'),
(9992, 'TOE', 'A digit on a foot'),
(9993, 'TENT', 'A fabric structure of shelter'),
(9994, 'SEA', 'There are seven of these bodies of water in the world'),
(9995, 'SOAP', 'A liquid used for washing'),
(9997, 'EAR', 'An organ used for hearing'),
(9998, 'EVEN', 'The opposite of odd'),
(77771, 'LOVE', 'The opposite of hate'),
(77772, 'LAZY', 'An adjective for describing something that avoids work'),
(77773, 'OPEN', 'The opposite of closed'),
(77774, 'HEAT', 'The presence of energy');
